...
namespace HATAGONG.Phase1
{
    ...
    {
        public int TileId, GridX, GridY, GridWidth, GridHeight, BaseHp, GradeHpModifier, BalanceHpModifier, RequestHpModifier, MaxHp;
        public Phase1TileShape Shape; public Phase1TileRole Role;
        public Phase1TileGrade Grade; public string GradeId,VisualSetId,UsedSpriteName; public bool VisualFallbackUsed,MinimumHpValid,IsSuperTile;
