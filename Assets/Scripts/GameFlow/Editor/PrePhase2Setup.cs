...
namespace HATAGONG.GameFlowEditor
{
    public static class PrePhase2Setup
    {
        ...
        public static void Setup()
        {
            ...
            var normalIcon=AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Resources/Ingame/ICON/RequestICON/Img_icon_normal.png");var suddenIcon=AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Resources/Ingame/ICON/RequestICON/Img_icon_sudden.png");if(!normalIcon||!suddenIcon)throw new System.InvalidOperationException("Required Request icon Sprite asset is missing.");
            ...
            var activeDot=AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Resources/Ingame/ICON/PhaseICON/Img_icon_phaseOn.png");var inactiveDot=AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Resources/Ingame/ICON/PhaseICON/Img_icon_phaseOff.png");if(!activeDot||!inactiveDot)throw new System.InvalidOperationException("Required Phase icon Sprite asset is missing.");
