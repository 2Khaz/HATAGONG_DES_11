...
Dragging은 최상단이며 이동 중 Field 밖/Loose 겹침을 허용한다. Field Drop 시 실제 TransformPoint Polygon 전체가 Field 안에 오도록 최소 Translation만 적용한다. Placed와 interior overlap이면 기존 Loose는 LastStableLoosePosition, Deck Piece는 Original Slot로 복귀한다.
...
- Press Offset, RMB/Wheel/R, Space 무반응
- Loose/Deck Return/Non-field Cancel
